...
All notable user-facing changes to Open in Basic Window are documented here.
...
- Local-only behavior with no data collection, analytics, tracking, or external service calls.
